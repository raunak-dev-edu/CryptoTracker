    ...
    return (
        ...
        <div>
            ...
            <div className={"flex flex-wrap items-center justify-center"}>
                ...
                { /* FLTER TABS */}
                <div className='flex gap-8 flex-wrap items-center  md:justify-center justify-around mt-5 md:mt-0'>
                    <p className={`${tabState === "all coins" ? "flex justify-center items-center w-24 h-9 rounded-md border border-emerald-600 cursor-pointer interFont scalee" : "flex justify-center items-center w-24 h-9 rounded-md bg-emerald-600 cursor-pointer interFont scalee text-white"}`} onClick={allCoinsHandler}> All Coins </p>
                    <p className={`${tabState === "metaverse" ? "flex justify-center items-center w-24 h-9 rounded-md border border-emerald-600 cursor-pointer interFont scalee" : "flex justify-center items-center w-24 h-9 rounded-md bg-emerald-600 cursor-pointer interFont scalee text-white"}`} onClick={metaVerseCategrotyHandler}> Metaverse </p>
                    <p className='flex justify-center items-center w-32 h-9 rounded-md bg-emerald-600 cursor-pointer interFont scalee gap-2 text-white' onClick={onOpen}>  <AiOutlineStar className='text-xl' /> Favourites </p>
                </div>
            ...
            <div className='flex gap-4 flex-wrap justify-center'>
                {pages.map((item) => {
                    ...
                    return (
                        <p key={item} className={active == item ? "bg-gray-700 text-white indivitualPage2 font-semibold cursor-pointer" : "indivitualPage font-semibold cursor-pointer"} onClick={(e) => {
